...
*(Додайте сюди скріншот вашого графа n8n: `![n8n workflow](assets/workflow-screenshot.png)`)*
...
## 📸 Демонстрація роботи
*(Додайте сюди 1-2 скріншоти діалогу з ботом у Telegram, де видно, як він гарно розписує витрати: `![Bot Demo](assets/bot-demo.png)`)*
...
---
*Проєкт створено для портфоліо як демонстрація можливостей автоматизації бізнес-процесів за допомогою AI агентів.*
